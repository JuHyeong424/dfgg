...
- [v] Automatic champion detection in champion select and in game
    Overlay support in exclusive fullscreen
    Movable and toggleable overlay
    Signed installer for public distribution
